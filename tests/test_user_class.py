...
class UserTest(unittest.TestCase):
    ...
    def setUp(self):
        self.user = User('chicken', 5, 'chick@chi.chi', 'somepassword', 'chicky')
    ...
    def test_user_class_has_valid_properties(self):
        ...
        for arg in args:
            self.assertTrue(hasattr(self.user, arg), msg='{} argument is missing.'.format(arg))
    ...
    def test_login_attribute_can_have_diff_values_per_user(self):
        self.user_2 = User('chicken', 5, 'chick@chi.chi', 'somepassword', 'chicky')
